  ...
  _createClass(Hotel, [{
    ...
    value: function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(context) {
        var _context$query, id, destination, res;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                console.log(res); // console.log(`Show data fetched. Count: ${hotel.name}`)
                // return { hotel, statusCode };
...
//# sourceMappingURL=hotel.js.60c06d34a743f87e4f9b.hot-update.js.map