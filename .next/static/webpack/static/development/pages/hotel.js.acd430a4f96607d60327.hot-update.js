...
/* WEBPACK VAR INJECTION */(function(module) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Hotel; });
...
function (_React$Component) {
  ...
  _createClass(Hotel, [{
    ...
    value: function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(context) {
        var _context$query, id, destination, res, statusCode;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                res = _context.sent;
                statusCode = res.status > 200 ? res.status : false; // const hotel = await res.json();

                console.log(res.status); // console.log(`Show data fetched. Count: ${hotel.name}`)
  ...
  return Hotel;
    ...
    })(typeof __webpack_exports__ !== 'undefined' ? __webpack_exports__.default : (module.exports.default || module.exports), "/hotel")
...
//# sourceMappingURL=hotel.js.acd430a4f96607d60327.hot-update.js.map